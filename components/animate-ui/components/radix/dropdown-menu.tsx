...
function DropdownMenuContent({
  ...
  return (
    <DropdownMenuContentPrimitive
      ...
      className={cn(
        'z-50 text-white rounded-2xl bg-black/40 backdrop-blur-md border border-white/20 shadow-[0_0_24px_rgba(255,255,255,0.15)] max-h-(--radix-dropdown-menu-content-available-height) min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto outline-none',
        className,
      )}
      {...props}
    >
      <DropdownMenuHighlightPrimitive className="absolute inset-0 z-0 rounded-2xl">
        {children}
  ...
  return (
    <DropdownMenuHighlightItemPrimitive disabled={disabled}>
      <DropdownMenuItemPrimitive
        ...
        className={cn(
          'relative flex cursor-default items-center gap-2 rounded-xl px-2 py-2 text-sm text-white select-none transition-colors data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 hover:bg-white/20',
          className,
        )}
        {...props}
      />
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuLabelPrimitive
      data-inset={inset}
      className={cn(
        'px-2 py-1.5 text-sm font-normal text-white/30 data-[inset]:pl-8',
        className,
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuSeparatorPrimitive
      className={cn('bg-white/20 -mx-1 my-2 h-px', className)}
      {...props}
    />
  );
}
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuSubContentPrimitive
      className={cn(
        'z-50 text-white rounded-2xl bg-black/40 backdrop-blur-md border border-white/20 shadow-[0_0_24px_rgba(255,255,255,0.15)] min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden outline-none',
        className,
      )}
      {...props}
    />
